...
| 5 | Full-offload | -160.9 | 0.923 | 0.1294 | 92.8 | 0.256 | 0.077 | +75.7 | 40/40 | 0.0000 / 0.0000 |
| 6 | Greedy | -143.0 | 0.932 | 0.1188 | 90.1 | 0.732 | 0.068 | +57.8 | 40/40 | 0.0000 / 0.0000 |
| 7 | E-Guard TEA | -120.0 | 0.947 | 0.1135 | 88.5 | 0.208 | 0.053 | +34.8 | 38/40 | 0.0000 / 0.0000 |
| 8 | Lyapunov | -118.2 | 0.948 | 0.1117 | 87.5 | 0.209 | 0.052 | +33.0 | 36/40 | 0.0000 / 0.0000 |
| 9 | TEA | -118.1 | 0.948 | 0.1117 | 87.5 | 0.209 | 0.052 | +32.9 | 36/40 | 0.0000 / 0.0000 |
| 10 | Deadline-TEA | -107.0 | 0.955 | 0.1106 | 92.4 | 0.208 | 0.045 | +21.8 | 34/40 | 0.0000 / 0.0000 |
| 11 | PPO (BC+KL) | -106.7 | 0.957 | 0.1130 | 148.7 | 0.199 | 0.043 | +21.5 | 40/40 | 0.0000 / 0.0000 |
| 12 | Follow-TEA | -93.2 | 0.965 | 0.1067 | 148.1 | 0.208 | 0.035 | +8.0 | 31/40 | 0.0000 / 0.0000 |
| 13 | Predict-TEA | -87.4 | 0.969 | 0.1073 | 148.2 | 0.206 | 0.031 | +2.2 | 34/40 | 0.0002 / 0.0000 |
| 14 | MPC-H3 (receding horizon) | -85.6 | 0.970 | 0.1074 | 124.0 | 0.207 | 0.030 | +0.4 | 14/40 | 0.6577 / 0.6179 |
| 15 | GDRL (ours) | -85.2 | 0.971 | 0.1071 | 147.7 | 0.207 | 0.029 |  — | — | — |
...
| 4 | Greedy | -213.8 | 0.915 | 0.1014 | 88.9 | 0.746 | 0.085 | +81.3 | 40/40 | 0.0000 / 0.0000 |
| 5 | Full-offload | -210.2 | 0.918 | 0.1058 | 95.5 | 0.225 | 0.082 | +77.6 | 40/40 | 0.0000 / 0.0000 |
| 6 | Lyapunov | -179.9 | 0.932 | 0.0964 | 87.6 | 0.192 | 0.068 | +47.3 | 40/40 | 0.0000 / 0.0000 |
| 7 | TEA | -179.9 | 0.932 | 0.0964 | 87.6 | 0.192 | 0.068 | +47.3 | 40/40 | 0.0000 / 0.0000 |
| 8 | E-Guard TEA | -176.5 | 0.934 | 0.0972 | 92.1 | 0.192 | 0.066 | +43.9 | 39/40 | 0.0000 / 0.0000 |
| 9 | PPO (BC+KL) | -165.7 | 0.941 | 0.1003 | 148.4 | 0.187 | 0.059 | +33.2 | 40/40 | 0.0000 / 0.0000 |
| 10 | Deadline-TEA | -162.6 | 0.941 | 0.0951 | 94.6 | 0.193 | 0.059 | +30.0 | 39/40 | 0.0000 / 0.0000 |
| 11 | Follow-TEA | -140.1 | 0.952 | 0.0922 | 147.9 | 0.194 | 0.048 | +7.5 | 35/40 | 0.0000 / 0.0000 |
| 12 | Predict-TEA | -137.0 | 0.954 | 0.0928 | 147.7 | 0.193 | 0.046 | +4.4 | 36/40 | 0.0000 / 0.0000 |
| 13 | MPC-H3 (receding horizon) | -134.8 | 0.955 | 0.0928 | 130.3 | 0.194 | 0.045 | +2.3 | 19/40 | 0.0283 / 0.1701 |
| 14 | GDRL (ours) | -132.6 | 0.956 | 0.0926 | 147.2 | 0.193 | 0.044 |  — | — | — |
...
# publication-quality figures (see `figures/`)
...
Figures (all in `figures/`): `convergence_{hard,stress}.png` (training curves),
`reward_{hard,stress}.png` (mean cost = -reward, error bars), `latency_{hard,stress}.png`,
`energy_{hard,stress}.png` (task + flight stacked), `success_{hard,stress}.png`,
`reward_boxplot_{hard,stress}.png` (per-episode distribution), `cdf_latency_{hard,stress}.png`,
`slot_latency_{hard,stress}.png` (per-slot curves), `trajectory_{hard,stress}.png` (UAV path),
`offload_stack_{hard,stress}.png` (local/UAV/LEO decision distribution), `tradeoff.png`
(latency-energy scatter), `ablation_gdrl.png` (contribution ablation),
`gdrl_gain_{hard,stress}.png` (paired per-episode gain).

...
## 7. ? UAV ???PMEO-M ? PMEO-M-Eco?2026-08-17?

? UAV ? PMEO ??? K ? UAV?PMEO-M??? ??-UAV ?????? ? ? ? UAV ???? ?
? **???**? {local, UAV_1..UAV_K, LEO} ?????**post-move association** ?????
? UAV ????????????????????? UAV ?/???/??????
??? `multi_uav_experiment_summary.md` ?3??

**PMEO-M-Eco??????**????????? H=3 ???????? UAV ?
{???, ????, ????, ???} ??????? 3 ?????????? + ?????????
???? PMEO-M ??????????? 443.6 vs MPC 320.6?????????? MPC ?
????? + ???????????1 ???? naive ?????? 0.1J ????????
**????????????**???????????????

**???10 seeds ? 10 episodes?9 ?????**?PMEO-M-Eco ? reward ?**??????
MPC-M-H3**?eco?mpc = +39.5 ~ +195.6?p<0.05??????????1.5 ~ ?9.2 J/slot??
??????????????? ~1.5 ??24s vs 36.5s/episode??k3 ????
reward `-2864.4 ? 220`?MPC -2955.9?p=0.034????? 90.7%???? 322.7?MPC 329.2??
? PMEO-M ? u80 ? MPC ???????? Eco ???u80?+68.9?p=0.005?9/10??
...
| PMEO-M-Eco?H=3 ???? + ????? | ??????????????????? | ????? |
| MPC-M-H3???????? | ???? | ???? Eco ???? |
| PMEO-M??????? | ???? + ???? | ????????????k3 +118.1?p=0.019? |
| Current-pos exact | ?????? | ???????+105.8?p<1e-51? |
